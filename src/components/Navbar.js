...
import NavSecMobile from './NavSecMobile';
...
const Navbar = () => {
  ...
  return (
    <Box>
      <Box>
        {!isMobile && <AppBar position="static" color="transparent" elevation={0} sx={{ background: 'linear-gradient(90deg, #fff 60%, #FFF3E6 100%)', boxShadow: 'none', px: 0, pt: 1 }}>
          <Toolbar sx={{ justifyContent: 'space-between', minHeight: { xs: 56, sm: 64 }, padding: '0px !important' }}>
